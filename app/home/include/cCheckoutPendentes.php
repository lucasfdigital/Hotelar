                ...
                while ($rowCheckout = mysqli_fetch_array($resultCheckout)) {
                    echo "
                        <tr> 
                            ...
                            <td> $rowCheckout[4] </td>
                            <td> $rowCheckout[5] </td>
                            <td> ". dataBrasil($rowCheckout[1])." </td>
                            <td> ". dataBrasil($rowCheckout[2])." </td>
                            <td> ". statusReserva($rowCheckout[3], 1)." </td>
                            <td style='text-align:center;' title='visualizar'> <a href='../reserva/visualizarReserva.php?id=$rowCheckout[0]' class='badge-card badge bg-blue1'> <i class='fa-solid fa-eye'></i> </a> </td>    
                        </tr>
                        ";
                }
                ?>
