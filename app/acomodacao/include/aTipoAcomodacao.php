...
if (isset($_POST['nome'])) {
    ...
    $sql = "UPDATE tipoacomodacao SET nome = '{$novoNome}' WHERE idtipoac = {$idtipo}";
    if (mysqli_query($con, $sql)) {
        if (mysqli_affected_rows($con)) { //VERIFICA SE HOUVE ALTERAÇÕES 
            ...
            $data = date("d/m/Y");
            $hora = date("H:i:s");
            $descricaoLog = "Funcionário: <b>$funcionario</b>, <b>editou</b> o tipo de acomodação de: <b>$nome</b> para <b> $novoNome </b>, no dia <b>$data</b> às <b>$hora</b>";
